...
namespace BlazorApp.Data
{
    ...
    {
        public System.Collections.Generic.List<Publisher> Publishers { get; set; }

        public PublisherService()
        {
            Publishers = new System.Collections.Generic.List<Publisher>();
        ...
        public System.Collections.Generic.List<Publisher> GetPublishers()
        {
            return Publishers;
        }
