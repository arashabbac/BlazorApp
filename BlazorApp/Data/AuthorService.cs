...
namespace BlazorApp.Data
{
    public class AuthorService : object , IAuthorService
    {
        ...
        System.Collections.Generic.List<Data.Author> Authors { get; set; }

        public AuthorService()
        {
            CreationDate = System.DateTime.Now;

            Authors = new System.Collections.Generic.List<Data.Author>();
            ...
            Authors.Add(new Data.Author(172321176, "Johnson", "White", "johnson.white@gmail.com" , 11000 , "408 496 7223", "Menlo Park"));
            Authors.Add(new Data.Author(213468915, "Marjorie", "Green", "marjorie.green@gmail.com", 22000, "415 986 7020", "Oakland"));
            Authors.Add(new Data.Author(238957766, "Cheryl", "Carson", "cheryl.carson@gmail.com", 39000 , "415 548 7723", "Berekley"));
            Authors.Add(new Data.Author(267412394, "Michael", "O'Leary", "michael.oleary@gmail.com", 31000 ,  "408 286 2428", "San Jose"));
            Authors.Add(new Data.Author(274809391, "Dean", "Straight", "dean.straight@gmail.com", 29000 , "415 834 2919", "Oakland"));
        }

        public System.Collections.Generic.List<Data.Author> GetAuthors()
        {
            return Authors;
        }

        public Data.Author GetAuthorById(int authorId)
        {
